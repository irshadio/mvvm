...
6. **Wiring**: route names (`core/routing/app_routes.dart`) + `app/route_generator.dart` entries; the `<feature>_overrides.dart` list and its registration in `lib/main.dart`.
